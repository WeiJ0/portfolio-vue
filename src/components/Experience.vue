            ...
            works: [
                {
                    ...
                    time: '2019/8 ~ 至今',
                    description: [
                        '維護公司露出官網，前台版面呈現及後台功能的開發，及 Google Analytics 的管理及導入，提供企劃人員使用者瀏覽資訊。',
                        '線上購物網站維護及功能開發，串接聯信金流 。',
                        '活動頁面建置，透過網頁拉進行銷及使用者間的距離。',
                        '公司 APP 開發及維護，使用 Cordova 建置雙平台行動應用程式。',
                        '簡易相關數據蒐集及建置報表供使用者瀏覽數據。'
                    ]
                },
            ]
        }
